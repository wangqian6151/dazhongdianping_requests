...
class Model():
    ...
    基类, 用来显示类的信息
    """
    db = pymongo.MongoClient()['DianPingMedical']
...
def medical_from_li(li):
    """
    从一个 li 里面获取到医疗健康商家信息
    """
...
def medical_from_url(url):
    ...
    education = [medical_from_li(i) for i in items]
    return education


def main():
    medicaltype = ['g183', 'g181', 'g182', 'g2914', 'g612', 'g235', 'g25148', 'g34050', 'g34053', 'g257', 'g34051',
                   'g34046', 'g34052', 'g34054', 'g34049', 'g34048', 'g2912']
